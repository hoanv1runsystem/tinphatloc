...
public class ReportController {
    ...
    public String view(Model model) {
        ...
        ExportResponse response = reportService.viewExport(dto, CommonConstant.DELETE_FLAG_ENABLE);
        ...
        model.addAttribute("reportDatas", response);
        return "/backend/export/viewReport";

    }

    @RequestMapping(value = "/export", method = RequestMethod.POST)
    public String doView(RequestReportDto dto, Model model) {

        //List<ReportDto> response = reportService.findAll(dto, CommonConstant.DELETE_FLAG_ENABLE);
        ExportResponse response = reportService.viewExport(dto, CommonConstant.DELETE_FLAG_ENABLE);
        dto.setThietBis(thietBiService.getAllData(CommonConstant.DELETE_FLAG_ENABLE));
        dto.setKhachHangs(khachHangService.getAllData(CommonConstant.DELETE_FLAG_ENABLE));
        dto.setCongTrinhs(congTrinhService.getAllData(CommonConstant.DELETE_FLAG_ENABLE));
    ...
    public ResponseEntity<byte[]> mutiCondition(RequestReportDto dto, Model model) {
    ...
    public ResponseEntity<byte[]> report(RequestReportDto dto, Model model) {
