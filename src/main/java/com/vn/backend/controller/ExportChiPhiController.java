...
public class ExportChiPhiController {

    @Autowired
    private ExportChiPhiService exportChiPhiService;
    ...
    @RequestMapping(value = "/export/chiPhi", method = RequestMethod.GET)
    public String viewChiPhi(Model model) {
        ...
        ExportChiPhiResponse response = exportChiPhiService.viewChiPhi(dto, CommonConstant.DELETE_FLAG_ENABLE);
        ...
        return "/backend/export/viewChiPhi";

    }

    @RequestMapping(value = "/export/chiPhi", method = RequestMethod.POST)
    public String doViewChiPhi(RequestExportDto dto, Model model) {
    ...
    @RequestMapping(value = "/export/muti-condition", method = RequestMethod.POST)
    public ResponseEntity<byte[]> mutiCondition(RequestExportDto dto, Model model) {

        byte[] bytes = exportChiPhiService.exportFileMutiCondition(dto, CommonConstant.DELETE_FLAG_ENABLE);
    ...
    @RequestMapping(value = "/export/condition", method = RequestMethod.POST)
    public ResponseEntity<byte[]> report(RequestExportDto dto, Model model) {

        byte[] bytes = exportChiPhiService.exportFileCondition(dto, CommonConstant.DELETE_FLAG_ENABLE);
